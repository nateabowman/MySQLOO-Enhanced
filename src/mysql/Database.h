...
public:
    ...
    unsigned int serverVersion() const;
    ...
    bool isConnectionDone() const { return m_connectionDone; }

    bool connectionSuccessful() const { return m_success; }

    bool attemptReconnect();

    std::string connectionError() const { return m_connection_err; }
